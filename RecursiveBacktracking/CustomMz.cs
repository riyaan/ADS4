...
namespace RecursiveBacktracking.Custom.Maze
{
    [Flags]
    ...
    public class Mz
    {
        ...
        public Mz(int rows, int columns)
        {
            MinSize = 3;
            MaxSize = 10;
        ...
        public void CarvePassagesFrom(int currentX, int currentY, ref int[,] grid)
        {
            ...
            foreach (var direction in directions)
            {
                ...
                Console.Write(String.Format("grid[{0},{1}]___", currentY, currentX));
                Console.Write(String.Format("(int)direction = {0}___", (int)direction));
                int temp = grid[currentY, currentX] |= (int)direction;
                Console.WriteLine(String.Format("grid[{0},{1}] |= (int){2} == {3}", currentY, currentX, direction, temp));
